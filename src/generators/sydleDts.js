 ...
 */
function generateSydleDts(rootPath) {
    const typingsPath = path.join(rootPath, 'typings');
...
// Generic _get method params (used by all classes)
declare interface I_GetParams {
    _id: string;
    _classId?: string;
}

// Generic _patch operation structure (used by all classes)
declare interface I_PatchOperation<FieldPaths = string> {
    _id: string;
    _operationsList: Array<{
