/**
 * @fileoverview Create Method Command
 * 
 * CLI command to scaffold a new method for a class.
 * Portuguese: sydle criarMetodo
 * English alias: sydle createMethod
 * 
 * @module commands/createMethod
 */
...
const createMethodCommand = new Command('criarMetodo')
    ...
    .action(async (pkgArg, classArg, methodArg, options) => {
        ...
        try {
            ...
            const methodName = await promptMethodName(methodArg);
